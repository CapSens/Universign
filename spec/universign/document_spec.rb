...
describe Universign::Document do
  describe ".new" do
    ...
    context "meta_data is not a hash" do
      it "raises an exception" do
        ...
        end.to raise_error(Universign::MetaDataMustBeAHash)
      end
    end
    ...
    context "content is set" do
      it "convert the content to XMLRPC::Base64 on params" do
        ...
        document = described_class.new(content: File.read(file))
  ...
  describe "#signature_fields=" do
    ...
    it "raises when not given an array" do
      ...
      end.to raise_error(Universign::SignatureFieldsMustBeAnArray)
    end
  ...
  describe "#check_box_texts=" do
    ...
    it "raises when not given an array" do
      ...
      end.to raise_error(Universign::CheckBoxTextsMustBeAnArray)
    end
  end
